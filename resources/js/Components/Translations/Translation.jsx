...
export const Translation = ({
    ...
    const [starStyle] = useState(
        translation.isFavourite
            ? "fa-solid text-amber-500"
            : "fa-regular text-gray-100",
    );

    // Set a favourite translation
    const submit = (e) => {
        e.preventDefault();

        router.put(
            `/setFavourite/${translation.id}/${set.title}`,
            !translation.isFavourite,
    ...
    return (
        ...
        >
            ...
            {permissions.canEdit && (
                <div
                    className={
                        "absolute flex gap-2 top-3 right-3 text-2xl items-center"
                    }
                >
                    <EditButton
                        onClick={() => {
                    ...
                    />
                    <button>
                        <i className={starStyle + " fa-star"}></i>
                    </button>
                </div>
            )}
        </form>
