            ...
            >
                ...
                <Container className="bg-white">
                    <div className="bg-white overflow-hidden sm:rounded-md">
                        <div className="flex items-center gap-4 text-md md:flex-row flex-col relative">
                            <div
                                ref={(element) => {
                            ...
                            >
                                <TestLink
                                    href={route("flashcards.learn", [
                                        set.id,
                                        set.title,
                                    ])}
                                >
                                    <i className="fa-solid fa-book-open mr-3 text-xl text-gray-600 transition"></i>
                                    Learn
                                </TestLink>
                            </div>
                            <div
                            ...
                            >
                                <TestLink
                                    href={route("flashcards.test", [
                                        set.id,
                                        set.title,
                                    ])}
                                >
                                    <i className="fa-solid fa-chalkboard-user mr-3 text-xl text-gray-600 transition"></i>
                                    Test
                                </TestLink>
                            </div>
                            <div
                            ...
                            >
                                <TestLink
                                    href={route("flashcards.match", [
                                        set.id,
                                        set.title,
                                    ])}
                                >
                                    <i className="fa-solid fa-copy mr-3 text-xl text-gray-600 transition"></i>
                                    Match
                                </TestLink>
                            </div>
                        </div>
                    ...
                    <div
                        className={
                            "translate-y-12 polygon-start opacity-0 my-4 w-full"
                        }
                        ref={(element) => {
                    ...
                    >
                        <Carousel
                            className="w-full relative flex flex-col sm:p-[4.5rem] bg-gradient-to-tl from-indigo-600 to-indigo-400 rounded-md"
                            pauseOnHover={true}
                            slide={!isEditing}
                    ...
                    <div className="space-y-4 rounded-md">
                        <div className="bg-gray-100 rounded-md px-4 py-2 flex gap-2 flex-col">
                            <div
                                ref={(element) => {
                                    mainRefs.current[5] = element;
                                }}
                                className={
                                    "polygon-start opacity-0 translate-y-12"
                                }
                            >
                                Created by
                        ...
                        >
                            {fetchedTranslations.map((translation, index) => (
                                <div
                                    ...
                                    ref={(element) =>
                                        (translationsRefs.current[index] =
                                            element)
                                    }
                                >
                                    <Translation
